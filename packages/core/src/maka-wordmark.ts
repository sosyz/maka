...
/**
 * Traced outline of Maka's product wordmark in its canonical 460×120 view box.
 * Renderers choose color through `currentColor`; the brand geometry has one owner.
 */
export const MAKA_WORDMARK_PATH =
